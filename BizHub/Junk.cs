...
//                oHierarchy.Lookups = GetTopLeveLookupsByLookupDefinitionOidForLoadingPurposesOnly(oDef.Oid);
...
//            RemoveChildLookupNodesFromTopLevel();
//        }

//        #region Load Hierarchies
//        private void CreateLookupNodes() {
//            // Foreach Lookup  - Check to see if the Lookup has a ParentOid.
//            // If it does it should be connected to a Parent.  We will do the connection by another method for the sake of Recursion
//            LookupNode oLookupNode;
//            foreach (Lookup oLookup in _lookups) {
//                if (oLookup.ParentOid != null) {
...
//                }
//            }
//            private void RemoveChildLookupNodesFromTopLevel() {
//                List<LookupNode> oDeleteList = new List<LookupNode>();
//                foreach (LookupNode oNode in _lookupNodes) {
//                    if (oNode.Parent != null) {
//                        oDeleteList.Add(oNode);
//                    }
//                }
//                foreach (LookupNode oNode in oDeleteList) {
//                    _lookupNodes.Remove(oNode);
//                }
//            }
...
//                        oLookup = Lookup.Add(tsLookupName, tsValue, tsDescription);
...
//            private List<Lookup> GetTopLeveLookupsByLookupDefinitionOidForLoadingPurposesOnly(Int64 tiLookupDefinitionOid) {
//                List<Lookup> oReturn = new List<Lookup>();
...
//                    foreach (Lookup oLookup in oList) {
//                        sReturn.Add(oLookup.GetValue(tsLanguage));
//                    }
//                }
//                return sReturn;
//            }
...
//                    if (oLookup != null) {
//                        sReturn = oLookup.GetValue(tsLanguage);
//                    }
//                }
//                return sReturn;
//            }
